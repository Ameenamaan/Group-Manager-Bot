...
def get_readable_time(seconds: int) -> str:
    ...
    return ping_time
PM_START_TEXT = """
`𝙷𝚎𝚕𝚕𝚘` [👿](https://telegra.ph/file/8959911c909702c924785.jpg) `𝙼𝚢 𝚗𝚊𝚖𝚎 𝚒𝚜` *Group Manager Bot*
`𝙸'𝚖 𝚑𝚎𝚛𝚎 𝚝𝚘 𝚑𝚎𝚕𝚙 𝚢𝚘𝚞 𝚖𝚊𝚗𝚊𝚐𝚎 𝚢𝚘𝚞𝚛 𝚐𝚛𝚘𝚞𝚙𝚜! 𝙷𝚒𝚝` *📚𝙲𝚘𝚖𝚖𝚊𝚗𝚍𝚜*   
"""
buttons = [
    [
        InlineKeyboardButton(
            text="𝐀𝐝𝐝 𝐌𝐞 𝐓𝐨 𝐘𝐨𝐮𝐫 𝐏𝐥𝐚𝐜𝐞😇", url="t.me/Super_Group_Manager_Bot?startgroup=true"),
    ],
     [
        InlineKeyboardButton(text="𝐀𝐛𝐨𝐮𝐭💝", callback_data="evil_"),
        InlineKeyboardButton(
            text="🤴 Dev", url=f"https://t.me/Ameen_Ameen_12"
        ),
     ],
     [  
        InlineKeyboardButton(text="⭕️Group⭕️", url="https://t.me/HDmoviePp"),
        InlineKeyboardButton(text="⭕️Channel⭕️", url="https://t.me/HDmovieDp"),
    ], 
...
HELP_STRINGS = """
`𝙷𝚎𝚢!.. 𝙸'𝚖` 👿 *Group Manager Bot* [👿](https://telegra.ph/file/8959911c909702c924785.jpg)
...
DONATE_STRING = """Heya, glad to hear you want to donate!
 You can support the project via [Paypal](#) or by contacting @Super_Group_Manager_Bot \
